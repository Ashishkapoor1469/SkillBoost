...
const Hero:React.FC = () => {
  return (
    <main
      className={`h-auto  mt-0 md:mt-30 xl:mt-30 lg:  min-w-screen flex md:flex-row flex-col-reverse md:justify-evenly items-center xl:p-0 px-10 `}
    >
      ...
      <div className="left w-full sm:w-130  h-full flex items-center justify-center md:mt-0 mt-16">
        <Image src="bg.svg" width={500} height={500} alt="BG.IMG"/>
      </div>
    </main>
  );
};
